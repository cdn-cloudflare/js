...
curriculumOutput += `<span class="lecture-title">${curriculum[i].title}</span></a> <span class="lecture-duration">(${curriculum[i].duration})</span> <a href="#ex${i+1}" rel="modal:open" class="lecture-popup"><span class="lecture-quick-play"><i class="fa fa-window-restore" aria-hidden="true"></i></span></a></td><td class="tcdl"><a href="${curriculum[i].link}" target="_blank"><span class="lecture-download-button"><i class="fa fa-download" aria-hidden="true" style="color:#fff;"></i> <!--<span class="lecture-download">Download</span>--></span></a></td>
</tr>`;
}
